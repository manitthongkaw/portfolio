    ...
    <section id="about">
      <div className="container">
        <div className="heading">
          ...
          <p>Today, I build full-stack web applications using the MERN stack, bringing every pixel and every API endpoint to the same standard. No design handoff. No lost-in-translation moments. Just clean, purposeful work from concept to deployment.</p>
